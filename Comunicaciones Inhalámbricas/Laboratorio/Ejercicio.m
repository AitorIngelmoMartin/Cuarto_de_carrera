...
R_cobertura1_50 = 10.^((Lb_2_dB - Beta - 10*Gamma*log10(f))./(10*Alfa));

% Apartado 5: Radio de cobertura (Rcob1) con una calidad del 90%
Aux    = U_dBm-erfcinv(2*0.9)*sqrt(2)*Sigma;
Lb2_dB = Ptx_dBm+Gtx_dB+Grx_dB-Aux;

R_cobertura1_90 = 10.^((Lb2_dB-Beta-10*Gamma*log10(f))./(10*Alfa))*1e-1;%En Km
...
Ptx_dBm_R_cobertura1_90=Aux-Gtx_dB-Grx_dB+Lb_2_dB;
