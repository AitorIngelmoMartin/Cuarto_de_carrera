...
BEGIN Epoch
    ...
    Epoch        27 Sep 2022 10:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	27 Sep 2022 10:00:00.000000000
			EventEpoch
...
Start                   27 Sep 2022 10:00:00.000000000
Stop                    27 Sep 2023 10:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	27 Sep 2022 10:00:00.000000000
...
BEGIN Intervals
    ...
    "27 Sep 2022 10:00:00.000000000" "27 Sep 2023 10:00:00.000000000"
END Intervals
...
END IntervalList
        ...
        WindowRectLeft    317
        WindowRectTop     655
        WindowRectRight   1794
        WindowRectBottom  1144
    END Report
...
BEGIN Extensions
    ...
    BEGIN ClsApp
		...
		LaunchWindowStart                       604800.000
		LaunchWindowStop                        -30844800.000
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	4 Oct 2022 10:00:00.000000000
				Stop	5 Oct 2022 10:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
    ...
    BEGIN Crdn
		BEGIN	EVENT
			...
			Description	Local midnight today.
				...
				ComputedDate      	10 Oct 2022 22:00:00.000000000
		END	EVENT
    END Crdn
...
BEGIN Animation
    ...
    StartTime          27 Sep 2022 10:00:00.000000000
    EndTime            27 Sep 2023 10:00:00.000000000
    CurrentTime        27 Sep 2022 12:27:11.775000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\Alumno\Documents\STK 11 (x64)\Scenario2
            BaseName         Frame
            Digits           4
            Frame            0
...
BEGIN References
    ...
    Instance Satellite/Geo
        Satellite/Geo
    END Instance
    Instance Satellite/LEO
        Satellite/LEO
    END Instance
    Instance Satellite/MEO
        Satellite/MEO
    END Instance
