...
BEGIN Epoch
    ...
    Epoch        3 Oct 2022 22:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	3 Oct 2022 22:00:00.000000000
			EventEpoch
...
BEGIN Extensions
    ...
    BEGIN ClsApp
		...
		LaunchWindowStart                       -561600.000
		LaunchWindowStop                        -561600.000
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				...
				Stop	28 Sep 2022 10:00:00.000000000
			END Interval
    ...
    BEGIN Crdn
		BEGIN	EVENT
			...
			Description	Local midnight today.
				...
				ComputedDate      	3 Oct 2022 22:00:00.000000000
		END	EVENT
		BEGIN	EVENT
			Type	EVENT_DATECONSTANT
			Name	Tomorrow
			...
			Description	Local midnight tomorrow.
				...
				LocalOffsetTime      	0.00000000000000e+00
				ComputedDate      	4 Oct 2022 22:00:00.000000000
		END	EVENT
    END Crdn
...
BEGIN Animation
    ...
    StartTime          3 Oct 2022 22:00:00.000000000
    EndTime            4 Oct 2022 22:00:00.000000000
    CurrentTime        3 Oct 2022 22:00:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\Alumno\Documents\STK 11 (x64)\Scenario1
            BaseName         Frame
            Digits           4
            Frame            0
